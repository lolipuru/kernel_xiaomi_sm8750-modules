...
#define CVP_CC_MVS0C_GDSCR			(CVP_CC_BASE_OFFS + 0x78)
#define CVP_CC_MVS0C_CBCR			(CVP_CC_BASE_OFFS + 0x90)
#define CVP_CC_MVS0_GDSCR			(CVP_CC_BASE_OFFS + 0xCC)
#define CVP_CC_MVS0_CBCR			(CVP_CC_BASE_OFFS + 0xE0)
#define CVP_CC_AHB_CBCR			(CVP_CC_BASE_OFFS + 0xF4)
#define CVP_CC_SLEEP_CBCR			(CVP_CC_BASE_OFFS + 0x150)

#define CVP_GCC_EVA_AXI0_CBCR		(0x8F004)
